...
const teamMembers = [
  { name: "Dr. Soumen Paul",img:"", img:"hod_img.jpg", gradient: "from-pink-500 to-purple-600" },
  { name: "Mr Manasija Bhattacharya", img:"mb_img.jpg", gradient: "from-blue-500 to-cyan-600" },
